        ...
        <AuthProvider>
          ...
          <BrowserRouter>
            <Routes>
              ...
              <Route path="/hospital-patients" element={<ProtectedRoute allowedRoles={['hospital']}><HospitalPatients /></ProtectedRoute>} />
              <Route path="/hospital-map" element={<ProtectedRoute allowedRoles={['hospital']}><LiveMap /></ProtectedRoute>} />
              <Route path="/hospital-analytics" element={<ProtectedRoute allowedRoles={['hospital']}><HospitalAnalytics /></ProtectedRoute>} />
